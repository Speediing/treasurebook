...
//                       return (
//                         <li key={i} className="flex flex-col w-full border-b border-neutral-300 ">
...
//                             >
//                               <div className="relative w-16 h-16 overflow-hidden border rounded-md cursor-pointer border-neutral-300 bg-neutral-300 ">
//                                 <Image
...
//                               />
//                               <div className="flex flex-row items-center ml-auto border rounded-full h-9 border-neutral-200 ">
...
//                     })}
//                   </ul>
//                   <div className="py-4 text-sm 0 text-neutral-500">
//                     <div className="flex items-center justify-between pb-1 mb-3 border-b border-neutral-200 ">
//                       <p>Taxes</p>
//                       <Price
//                         className="text-base text-right text-black "
        ...
        <Dialog onClose={closeCart} className="relative z-50">
          ...
          >
            <Dialog.Panel className="fixed bottom-0 right-0 top-0 flex h-full w-full flex-col border-l border-neutral-200 bg-white/80 p-6 text-black backdrop-blur-xl dark:border-neutral-700 dark:bg-black/80 dark:text-white md:w-[390px]">
              ...
              {!cart || cart.lines.length === 0 ? (
                <div className="mt-20 flex w-full flex-col items-start justify-center gap-2 overflow-hidden text-sm">
                  {/* <ShoppingCartIcon className="h-16" /> */}
                  <p className="mt-6 text-center">You haven&apos;t put any items in your bag</p>
                  <Link href={'/search'}>
                    <p className="underline">Start Shopping</p>
                  </Link>
                </div>
              ) : (
                          ...
                          <div className="relative flex w-full flex-row justify-between px-1 py-4">
                            ...
                            <div className="flex h-16 flex-col justify-between">
                              <Price
                                ...
                                currencyCode={item.cost.totalAmount.currencyCode}
                              />
                              <div className="ml-auto flex h-9 flex-row items-center rounded-none border border-neutral-200 dark:border-neutral-700">
                                <EditItemQuantityButton item={item} type="minus" />
                                <p className="w-6 text-center">
                                  <span className="w-full text-sm">{item.quantity}</span>
                                </p>
